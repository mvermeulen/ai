...
- **Max Value Matches**: Only 8 of the 62 max value peaks share their peak value with any steps peaks or stopping time peaks. For a detailed family mapping and trace of these merges, see the [Paths Taken by Peaks in Maximum Values Investigation](file:///home/mev/source/ai/hailstone/doc/2026-06-15-max_value_path_investigation.md).
...
- **Empirical Validation**: In both stopping time peaks and maximum value peaks, the peak `^` is always reached before the stopping time `|`. For steps peaks, however, **70%** exhibit the stopping time before the peak because they inherit their peak from smaller trajectories. For a detailed analysis of this duality, see the [Paths Taken by Peaks in Stopping Time Investigation](file:///home/mev/source/ai/hailstone/doc/2026-06-15-stopping_time_path_investigation.md) and the [Paths Taken by Peaks in Maximum Values Investigation](file:///home/mev/source/ai/hailstone/doc/2026-06-15-max_value_path_investigation.md).
