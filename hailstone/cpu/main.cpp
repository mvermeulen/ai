...
void print_help() {
    std::cout << "Usage: hailstone_cpu [options] [positional_start] [positional_end]\n\n"
              << "Options:\n"
...
int main(int argc, char* argv[]) {
    ...
    cpu_search_range(start, end, max_value_peaks, steps_peaks, sigma_peaks, global_peaks, metrics);
